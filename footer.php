    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <br>
				<div id="JdBadge" data-s1="b1" data-s2="Y3RyY3QlNDAlNDAlNDA5OTk5UFg0MTYlMkJYNDE2JTJCMTkwMzExMTExMTQ1JTJCRzhZMg=="></div><div id="JdBadgeDest"></div><script type="text/javascript" src="https://www.justdial.com/Jd-Widget"></script>
...
.flickr_badge_image img { padding:1px; margin:2px;width:60px;height:60px;border-radius:3px;filter:grayscale(100);}
.flickr_badge_image img:hover{filter: grayscale(0);}                                            
...
.banner-form{ display: none;position: fixed;
    bottom: 58px;
    left: : 0;
    z-index: 999;}
.banner-form-inner{  
    background: linear-gradient(to bottom,#45c4e9 0,#ccc 100%);
    height: 340px;
    width: 350px;
}

.sticky-btn{position: fixed;bottom: 0;left: 0;    font-family: "Lato", sans-serif;
    width: 350px;background:#45c4e9;padding: 20px 0;color: #fff;text-align: center;cursor:pointer;z-index: 999;}
    .form-header {
    color: white;
    padding: 5px 20px;
    text-align: left;
...
<!-- <div class="sticky-btn">Get started with us!</div>
<div class="sticky-form" id="sticky-form">
                            <div class="banner-form" style="display: none;">
                            <div class="banner-form-inner">
                                <div class="form-header">
                                    <p class="hight">Get started with us!</p>
                                </div>
                                 <div id="sucessMessage" style="display: none;"></div>
                               <form method="post" name="enquiry_form" action="">
                                    ...
                                    <br>-->
                                       <!--<input type="submit" name="submit" id="submit" class="submit_btn"/> -->                                        
                                        <!-- <button type="button" name="submit" id="submit" class="submit_btn">Submit</button>                              
                                        <p>or call us at <span style="font-weight: 

bold;font-size: 16px;color: #a3750d;cursor: pointer;"><a href="tel:8189985559" style="color: #3f8194;">+91 8189985559</span></p>
...
$(".sticky-btn").click(function(){
    ...
    $(".banner-form").toggle(500).css({"display":"block"})
     });
});
</script>
