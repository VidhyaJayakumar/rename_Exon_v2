...
<meta charset="utf-8">
    ...
    <title>Google Apps | WebHosting | Hosting Services | Domain Hosting | Domain Registration | Unlimited Hosting | Best Website Hosting | Linux Hosting | Reseller Hosting | Domain Name Registration | Web Hosting Company | Green Web Hosting | Windows Hosting | Shared Hosting | SSL Security | DNS Black Listing Services @ Exincorp Cloud in India</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <h1>Google Apps</h1>
        <div class="sub_heading_page"><strong>G Suite</strong> for your Work</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="hosting_price">
        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
          <div class="price_holder">
            <h4>Google Apps Plan 1</h4>
            <div class="plan_value"><span>$</span>1.02</div>
            <ul>
              <li>Google Business email (name@yourcompany.com) </li>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-duration=".3" data-wow-delay=".2s">
          <div class="price_holder">
            <h4>Google Apps Plan 2</h4>
            <div class="plan_value"><span>$</span>7.57</div>
            <ul>
              <li>Google Business email (name@yourcompany.com) </li>
              <li>Video and voice calls</li>
              <li>Integrated online calendars</li>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
          <div class="choose_r_options"><i class="fa fa-server gradient_color"></i>
            <h5 class="section_sub_heading">Real-Time Collaboration</h5>
            <p>Work with teams across continents or rooms, seamlessly. Edit presentations, docs together, in real-time.</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
          <div class="choose_r_options"><i class="fa fa-lock gradient_color"></i>
            <h5 class="section_sub_heading">Advanced admin controls</h5>
            <p>1 Central Admin panel to add/remove users, setup groups & add security measures like 2-Step Authentication & Single-Sign-On.</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s">
          <div class="choose_r_options"><i class="fa fa-envelope gradient_color"></i>
            <h5 class="section_sub_heading">All the storage you need</h5>
            <p>30GB of online storage per useron Google’s cloud platform is integral part of how Google enables collaboration.</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".7s">
          <div class="choose_r_options"><i class="fa fa-server gradient_color"></i>
            <h5 class="section_sub_heading">Work from Anywhere. Anytime.</h5>
            <p>With all your work, files, docs on the Cloud. You're at Work, whenever you want.</p>
          </div>
        </div>
      </div>
    </div>
