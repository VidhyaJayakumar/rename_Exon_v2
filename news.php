            ...
            <div class="col-md-12">
                <div class="left pull-left">
                    <ul>
                        ...
                        <a href="news.php">   <li class="active">News</li></a>
                    </ul>
                </div>
...
<section class="latest-blog-area sec-padding">
    <div class="container">
        <div class="sec-title pdb-50 text-center">
            ...
            <p>Latest News and Events and on going projects and courses updated on blog soon.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    <div class="img-holder">
                        <img src="images/blog/blog.jpg" alt="Awesome Image">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Guest Lecture at Web Security and its Web Applications Organized by School of Information Technology and Engineering.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    <div class="img-holder">
                        <img src="images/blog/blog1.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Visited TIFAC-CORE in Automotive Infotronics,VIT University,Vellore to collaborate in the area of "Video based Forensic System.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    <div class="img-holder">
                        <img src="images/blog/blog2.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                    ...
                    <div class="text-holder">
                        <ul class="meta-info">
                            ...
                            <li><a href="#">Industrial Visit, at 10 Am</a></li>
                        </ul>
                        <a href="#">
                            <h3 class="blog-title">Visit by Muthukumaran Institute Of Technology, Chennai</h3>
                        </a>
                        <div class="text">
                            <p>Students of Information Technology Final year, from Muthukumaran Institute of Technology, Mangadu , Chennai.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>One Day National Workshop Ethical Hacking & Cyber Security Organized By Department of Digital Communications School of Information Technology and Engineering.
.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p> Students of around 500+ from Information Technology and Computer Science Department participated in IV Network Security. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Sri Rama Krishna Polytechnic Students participated in the workshop and recieved Internships and Merit Certificate for active Participation. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
               ...
               <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Students of Computer Science and Engineering learned about the recent trends of technology and practical implementation of Cloud. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
               ...
               <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Department of Computer Science and Engineering Participated on topics Internet Of Things , Cloud computing and Firewall. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
               ...
               <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>tudents of Information Technology Final year, from Muthukumaran Institute of Technology, Mangadu , Chennai. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
               ...
               <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Students around 100 have done Internships on Hardware, Networking , Server management, Cyber Security, IT Audit and Governance , Information Secuirty, etc ...</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
             ...
             <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Internship on Cyber Security and Cyber Forensics done by Madras University students gave an out standing results on Oxygen Forensics and Detection. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
             ...
             <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>SKP College of Engineering, Thiruvanamalai of Computer Science Department students participated in the workshop and recieved Internships and Merit Certificate for active Participation. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Students of Sathya arts and Science College , Vellore participated in one day workshop and Certificate of Merit is presented to the students. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p> About 1000+ candidates participated in this workshop from 30 different Colleges in and  around Vellore, gudiyatham, Kanchipuram.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>500+ students have been participated in this workshop, also collaboration certificate is given to the college to provide free workshops and Internships. </p>
           ...
           <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>One Day National Workshop Ethical Hacking & Cyber Security Organized By Department of BCA and Computer Science Students at KMG Arts College, Gudiyatham
.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p> Physical Security awareness program is conducted based on Industry Security at Rajan & Rajan Industry , Kanchipuram. </p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
 ...
 <!--<div class="row">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <ul class="post-pagination text-center">
                                ...
                                <li><a href="news2.php">3</a></li>

                                <li><a href="news1.php"><i class="fa fa-caret-right" aria-hidden="true"></i></a></li>
