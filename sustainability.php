...
<html lang="en">
 ...
 <head>
	<meta charset="UTF-8">
	<title>Sustainability| ExonCorp</title>
                        ...
                        <div class="col-md-12">
                            <div class="single-item">
                                <div class="img-holder">
                                    <img src="images/services/sustainability.jpg" alt="Awesome Image">
                                </div>
                                <div class="text-holder">
                                    <p class="mar-btm15">We work closely with Employers across all industry sectors to ensure that their internal sed Human Resource systems processes align to their business requirements idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth. Take a 360-degree sed view of yours situations using our seds deep experience, industries specialization and global reach.</p>
            ...
            <div class="col-lg-4 col-md-5 col-sm-7 col-xs-12 pull-left">
                <div class="left-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="page-link">
                            <li><a href="business-growth.php">Business Growth</a></li>
                            <li><a class="active" href="sustainability.php">Sustainability</a></li>
                            <li><a href="performance.php">Performance</a></li>
                            <li><a href="advanced-analytics.php">Advanced Analytics</a></li>
                            <li><a href="organization.php">Organization</a></li>
                            <li><a href="customer-insights.php">Customer Insights</a></li>              
                        </ul>
                    </div>
                    <!--End single sidebar-->
                    <!--Start single sidebar-->
