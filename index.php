...
<!-- End Google Tag Manager (noscript) -->    
   ...
   <!--  <link rel="icon" type="image/png" href="images/favicon/favicon2.png" sizes="32x32"> -->
    <link rel="icon" type="image/png" href="images/favicon/favicon1.png" sizes="16x16">
...
"IN" }
     ...
     <meta name="google-site-verification" content="NA5JHu1KKrfCD70bl1MViWi2hKtTNTz_Lf0HA67CtGU" />
...
<div class='popup' class="col-sm">
<div class='cnt223' class="col-sm">
<h1><input type="button" class="btn btn-danger" value="Disclaimer"></h1>
<p style="text-align:justify">

This website and the contents of these web pages are under construction. Also the contents Being upgraded and shall be altered regularly. 
<br><br>
...
<br/>
<br/>
<a href='' class='close'>I AGREE</a><a href='https://google.com'>DISAGREE</a>
</p>
</div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="single-service-item text-center">
                    ...
                    <div class="text-holder">
                        <div class="text">
                            <a href="#"><h3 class="title">Proven Expertise</h3></a>
                            <p>Over 8 years of domain experience and service excellence makes us best in the region to be your preferred technology partner.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="single-service-item text-center">
                    ...
                    <div class="text-holder">
                        <div class="text">
                            <a href="#"><h3 class="title">Expert Support</h3></a>
                            <p>We have a competent pool of certified & experienced in-house engineers, to provide 24 / 7 support to our esteemed customer base.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="single-service-item text-center">
                    ...
                    <div class="text-holder">
                        <div class="text">
                            <a href="#"><h3 class="title">We Offer The Best</h3></a>
                            <p>We offer advanced technology, robust infrastructure, large pool of talents and proven global delivery standards.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="singel-box hvr-float">
                        ...
                        <div class="text-holder">
                            <p>Ever undertakes laborious physical exercise, except to obtain some advantage from it. To find fault with a consequences.</p>
                        </div>
                    </div>
                </div>
                <!--End single box-->
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="request-form">
                    ...
                    <form id="request-form" name="request-form" action="email1.php" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="selectmenu" name="select">
