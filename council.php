	    ...
	    <div class="row">
	        <div class="col-md-12">
	            <div class="breadcrumbs">
	                <h1>EXONCORP CYBER SECURITY COUNCIL</h1>
	            </div>
	        </div>
	    </div>
	</div>
            ...
            <div class="col-md-12">
                <div class="left pull-left">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active"><a href="council.php">Security Services</a></li>
                    </ul>
                </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="single-item">
                                    ...
                                    <div class="text-holder">
                                        ...
                                        <p>CYBER RISK AND RESILIENCE MANAGEMENT
 </p>
                                        <p>ETHICAL HACKING AND COUNTER MEASURES </p>
                                        <p>NETWORK INTRUSION DETECTION</p>
                                        <p>CYBER SECURITY ENGINEERING</p>
                                        <p>DIGITAL INTELLIGENCE AND INVESTIGATION</p>
                                        <p>INCIDENT MANAGEMENT</p>
                                        <p>NETWORK SITUATIONAL AWARENESS</p>
                                        <p>SECURE NETWORK MANAGEMENT</p>
                                        <p>PRINCIPLES OF E-BUSINESS SECURITY</p>
