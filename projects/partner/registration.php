...
$duplicate=mysqli_query($mysqli,"SELECT * from users where type='PARTNER' AND mobile='$fmob' or email='$email' ");
	...
	else
	{
	 $query = mysqli_query($mysqli, "INSERT INTO `users`(`name`, `email`, `mobile`, `password`, `type`, `status`, 
	 	`logs`) VALUES ('$fname', '$email', '$fmob', '$pass', 'PARTNER', 'NO', '$logs')");
		if($query)
		{
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box">
                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="registration.php" method="post" name="email">
