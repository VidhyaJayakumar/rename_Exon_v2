                ...
                <div class="page-title-wrapper-inner">
                    <div class="page-title-container">
                        <div class="inner page-title">
                            ...
                            <h2 class="page-title-heading white-text">Portfolio Masonry.</h2>
                    ...
                    <div class="row">
						...
						<div class="col">
							<div class="card-columns">
								...
								<div class="card card-inverse mb-20 card-primary p-3 text-center">
								...
								<div class="card text-center mb-20">
									<div class="card-block">
										<h5 class="card-title">Finance Consultancy</h5>
										<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
										<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
									</div>
								</div>
								...
								<div class="card mb-20">
									<img class="card-img img-fluid" src="images/demo-img-6.jpg" alt="Card image">
								</div>

								<div class="card p-3 mb-20 text-right">
									<blockquote class="card-blockquote">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
										<footer>
											<small class="text-muted">
								...
								<div class="card card-inverse mb-20 info-on-hover">
									<img class="card-img img-fluid" src="images/demo-img-3.jpg" alt="Card image">
								...
								<div class="card card-inverse mb-20 card-warning  p-3 text-right">
									<blockquote class="card-blockquote">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
										<footer>
											<small>
