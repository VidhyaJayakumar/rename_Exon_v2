                ...
                <div class="page-title-wrapper-inner">
                    <div class="page-title-container">
                        <div class="inner page-title mt-4">
                            ...
                            <h2 class="page-title-heading">FAQs.</h2>
                            ...
                            <div class="card">
                            	<div class="card-block">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>What exactly you get with this?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>How do you decide charges for this?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>What are deliverables in this service?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>How many resources are involved?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>How fast my website will be complete?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="faq-div">
                                                <h6>How well is the documentation?</h6>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad.</p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-6 -->
