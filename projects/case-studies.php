                ...
                <div class="page-title-wrapper-inner">
                    <div class="page-title-container">
                        <div class="inner page-title mt-4">
                            <h2 class="page-title-heading">Case Studies.</h2>
                        ...
                        <div class="col">
                            ...
                            <div class="card mb-20">
                            	<div class="card-block">
                                    ...
                                    <h5 class="text-muted">Our Latest Cases:</h5>
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                    		<div class="card news-card">
                                    			<div class="card-block">
                                    				...
                                    				<a href="case-study-details.php" class="btn btn-primary btn-sm">Read more</a>
                                    			</div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                    		<div class="card news-card">
                                    			<div class="card-block">
                                    				<h5 class="card-title">Retail is on boom.</h5>
                                    				<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                    				<a href="case-study-details.php" class="btn btn-primary btn-sm">Read more</a>
                                    			</div>
                                                <div class="card-footer">
                                        ...
                                        <div class="col-md-6 mb-4">
                                    		<div class="card news-card">
                                                ...
                                                <div class="card-footer">
                                                	<small class="text-muted">Last updated 18 days ago</small>
                                                </div>
                                    		</div>
                                    	</div>
                                        <!-- /.col-md-6 mb-4 -->
                        ...
                        <div class="col-lg-3 sidebar">
                            <div class="card mb-4">
                            	<ul class="list-group list-group-flush">
                            		<li class="list-group-item active"><a href="case-studies.php">Case Studies</a></li>
                                    <li class="list-group-item"><a href="case-study-details.php">Case Study Details</a></li>
                            	</ul>
                            </div>
