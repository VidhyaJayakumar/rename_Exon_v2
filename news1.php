            ...
            <div class="col-md-4">
                <div class="single-blog-item">
                    ...
                    <div class="text-holder">
                        ...
                        <div class="text">
                            <p>Students around 100 have done Internships on Hardware, Networking , Server management, Cyber Security, IT Audit and Governance , Information Secuirty, Website Design and Development, SEO Analyst.</p>
                        </div>
                        <div class="bottom">
                            <div class="left pull-left">
                                <a href="#">Read More</a>
...
<div class="row">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <ul class="post-pagination text-center">
                                ...
                                <li><a href="news.php"><i class="fa fa-caret-left" aria-hidden="true"></i></a></li>

                                <li><a href="news.php">1</a></li>

                                <li  class="active"><a href="news1.php">2</a></li>

                                <li><a href="news2.php">3</a></li>

                                <li><a href="news2.php"><i class="fa fa-caret-right" aria-hidden="true"></i></a></li>
