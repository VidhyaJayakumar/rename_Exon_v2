          ...
          <div class="four columns">
               ...
               <ul class="get-in-touch">
                    <li ><i class="ss-location"></i>
                     ...
                     <li><i class="ss-phone"style="font-size:20px;"></i>
                         <p> +91 81899 85551 &nbsp; +91 81899 85559</p>
                    </li>
                   
                    <li><i class="ss-mail"></i>
                         <p><strong>Email:</strong> <a href="mailto:studios@redbacks.in">studios@redbacks.in</a></p>
                    </li>
                    <li>
...
<div class="eight columns">
             ...
             <!--   <center>
               ...
               <div class="eight columns">
                    ...
                    <br>
					<form action="//redbackstudios.us11.list-manage.com/subscribe/post?u=d3c1ba0013e2b7a0cf2fe1e59&amp;id=8abdf6d59e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    ...
    margin-top: 12px;">Subscribe</button>
          ...
          <div class="four columns">
               <h3>Support Partners</h3>
                <div class="footer_tags">
                    <ul>
                         <li><a href="http://seosearch.in" title="Web Development Company in Chennai">Seo Search</a></li>
                         <li><a href="http://digitalmarketingventure.com" title="Web design company in vellore">Digital Marketing Venture</a></li>
                         <li><a href="http://quickix.com" title="Digital Marketing Company in Bangalore">Quickix</a></li>
                         <li><a href="http://velloreads.com" title="Redback Academy in Gudiyatham">Velloreads</a></li>
						<li><a href="http://seodigitalmark.com" title="Redback Academy in Coimbatore">Seodigitalmark</a></li>
...
<div id="footer-bottom" style="height:5px">
     <!-- Container -->
     <div class="container">
           <div class="eight columns">Copyright &#169; <?php echo date('Y'); ?> Redback Studios Inc. All Rights Reserved. Created with <span style="color: #e02c3f">♥</span> by <a href="http://www.redbackstudios.in/" title="websitedevelopment vellore, redbackstudios,webdesign,domainregistration,webhosting,digitalmarketing,seo,vellore!" >Redback</div>
          ...
          <div class="eight columns">
               <ul class="social-icons-footer">
					...
					<li><a href="http://linkedin.com/company/redbackstudios" target="_blank" class="tooltip top" title="LinkedIn"><i class="icon-linkedin-rect"></i></a></li>
